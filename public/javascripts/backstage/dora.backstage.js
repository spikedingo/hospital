...
//权限管理数据初始化
    //id:所属一级分类_二级分类_行为  pID：所属一级分类_二级分类
function setAdminPowerTreeData(){
    return [
        ...
        { id:'contentManage_department', pId:'contentManage', name:"科室管理", open:true},
        { id:'contentManage_department_add', pId:'contentManage_department', name:"新增"},
        { id:'contentManage_department_view', pId:'contentManage_department', name:"查看"},
        { id:'contentManage_department_modify', pId:'contentManage_department', name:"修改"},
        { id:'contentManage_department_del', pId:'contentManage_department', name:"删除"},

        { id:'contentManage_doctor', pId:'contentManage', name:"医生管理", open:true},
        { id:'contentManage_doctor_add', pId:'contentManage_doctor', name:"新增"},
        { id:'contentManage_doctor_view', pId:'contentManage_doctor', name:"查看"},
        { id:'contentManage_doctor_modify', pId:'contentManage_doctor', name:"修改"},
        { id:'contentManage_doctor_del', pId:'contentManage_doctor', name:"删除"},
...
function contentTypeFilter(){
    $(".contentFilter").find('select').change(function () {
        console.log($(this).val());
        $(".contentFilterInput").val($(this).val());
    });
};